...
#Modelo padrão, estou usando a .pt que é uma versão pré treinada da ultralytics
    ...
    if not cap.isOpened():
        ...
        while cap.isOpened():
            ...
            if sucess:
                ...
                #A ia está analisando oque está vendo
                results = model(frame)

                #Nesse moemento ela desenha os resultados na tela
